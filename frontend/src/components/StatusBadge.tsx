...
export const StatusBadge: React.FC<{ status: ComplaintStatus }> = ({ status }) => {
  ...
  const styles: Record<ComplaintStatus, string> = {
    ...
    NEEDS_VERIFICATION: 'bg-amber-100 text-amber-900 border-amber-300 font-bold',
    Verified: 'bg-blue-50 text-blue-800 border-blue-300',
    Approved: 'bg-blue-50 text-blue-800 border-blue-300',
    'Department Assigned': 'bg-sky-50 text-sky-800 border-sky-300',
    'Staff Assigned': 'bg-cyan-50 text-cyan-900 border-cyan-300',
    ...
    'In Progress': 'bg-amber-50 text-amber-900 border-amber-300 font-semibold',
    'Resolution Submitted': 'bg-purple-50 text-purple-900 border-purple-300 font-bold',
    Resolved: 'bg-emerald-50 text-emerald-800 border-emerald-300 font-bold',
    Reopened: 'bg-orange-50 text-orange-900 border-orange-300 font-bold',
