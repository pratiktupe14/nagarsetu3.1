...
Status: EXTERNAL ACTION REQUIRED (REQUIRED FOR PHASE 3 CLOSURE)
...
- ACTUAL RESULT: [EXTERNAL ACTION REQUIRED]
- EVIDENCE: Project Reference ID / Dashboard Screenshot
- STATUS: NOT VERIFIED (EXTERNAL ACTION REQUIRED)
...
- ACTUAL RESULT: Start: [HH:MM:SS], End: [HH:MM:SS] [EXTERNAL ACTION REQUIRED]
...
- ACTUAL RESULT: Measured RPO: [X minutes] [EXTERNAL ACTION REQUIRED]
- EVIDENCE: Transaction timestamp comparison log
- STATUS: NOT MEASURED (EXTERNAL ACTION REQUIRED)
...
- ACTUAL RESULT: Measured RTO: [Y minutes] [EXTERNAL ACTION REQUIRED]
...
- ACTUAL RESULT: Signed by: [Name/Role], Date: [YYYY-MM-DD] [EXTERNAL ACTION REQUIRED]
