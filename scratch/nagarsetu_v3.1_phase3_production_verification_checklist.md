...
Status: REQUIRED EXTERNAL ACTION (REQUIRED FOR PHASE 3 CLOSURE)

==================================================
OPERATIONAL VERIFICATION FIELDS
==================================================

- Production project: [REQUIRED EXTERNAL ACTION]
- Backup enabled: [REQUIRED EXTERNAL ACTION]
- Backup frequency: [REQUIRED EXTERNAL ACTION]
- Latest backup: [REQUIRED EXTERNAL ACTION]
- Retention: [REQUIRED EXTERNAL ACTION]
- PITR: [REQUIRED EXTERNAL ACTION]
- Recovery window: [REQUIRED EXTERNAL ACTION]
- Restore mechanism: [REQUIRED EXTERNAL ACTION]
- Restore source: [REQUIRED EXTERNAL ACTION]
- Restore target: [REQUIRED EXTERNAL ACTION]
- Restore start: [REQUIRED EXTERNAL ACTION]
- Restore completion: [REQUIRED EXTERNAL ACTION]
- Restore result: [REQUIRED EXTERNAL ACTION]
- DB integrity: [REQUIRED EXTERNAL ACTION]
- DB ↔ Storage: [REQUIRED EXTERNAL ACTION]
- Measured RPO: [REQUIRED EXTERNAL ACTION]
- Measured RTO: [REQUIRED EXTERNAL ACTION]
- Administrator: [REQUIRED EXTERNAL ACTION]
- Verification date: [REQUIRED EXTERNAL ACTION]
- Evidence reference: [REQUIRED EXTERNAL ACTION]

==================================================
OPERATIONAL INSTRUCTIONS
==================================================

This checklist provides the exact verification sequence required for an authorized administrator with Supabase Cloud Console credentials to complete physical backup verification, PITR enablement check, and safe non-production restore drill.

Execute each step below, record observed values, and capture screenshot/log evidence into the checklist table.
...
- ACTUAL RESULT: [REQUIRED EXTERNAL ACTION]
- EVIDENCE: Project Reference ID / Dashboard Screenshot
- STATUS: NOT VERIFIED (REQUIRED EXTERNAL ACTION)
...
- EXPECTED RESULT: Continuous recovery window covers last 7 to 30 days to seconds precision.
- ACTUAL RESULT: [REQUIRED EXTERNAL ACTION]
...
- Instructions: Provision a clean, isolated staging project or test database instance (e.g. `nagarsetu-staging-recovery`). NEVER restore over the active production instance.
...
- ACTUAL RESULT: Start: [HH:MM:SS], End: [HH:MM:SS] [REQUIRED EXTERNAL ACTION]
...
- ACTUAL RESULT: Measured RPO: [X minutes] [REQUIRED EXTERNAL ACTION]
- EVIDENCE: Transaction timestamp comparison log
- STATUS: NOT MEASURED (REQUIRED EXTERNAL ACTION)
...
- ACTUAL RESULT: Measured RTO: [Y minutes] [REQUIRED EXTERNAL ACTION]
...
- ACTUAL RESULT: Signed by: [Name/Role], Date: [YYYY-MM-DD] [REQUIRED EXTERNAL ACTION]
